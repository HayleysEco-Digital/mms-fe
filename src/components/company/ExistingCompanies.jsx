...
import { deleteCompany, getAllCompanies } from "../utils/ApiFunctions";
    ...
    const handleConfirmDelete = async () => {
        if (confirmText === "DELETE") {
            try {
                ...
                if (result === "") {
                    toast.success(`Company No ${companyToDelete} was successfully deleted!`);
                    fetchCompanies(); // Refresh the companies list
                } else {
                    toast.error(`Error deleting company: ${result.message}`);
                }
            } catch (error) {
    ...
    return (
        <>
            ...
            <Modal show={showDeleteModal} onHide={() => setShowDeleteModal(false)}>
                ...
                <Modal.Body>
                    <p>Are you sure you want to delete Company No {companyToDelete}?</p>
                    <p>
