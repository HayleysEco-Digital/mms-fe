...
import { addEmployee, addRoom, getUser, updateUserProfileCompletion } from "../utils/ApiFunctions"
...
const AddEmployee = () => {
	...
	useEffect(() => {
		const fetchUser = async () => {
			try {
				...
				setNewEmployee({ ...newEmployee, empNo: userData.empNo, empFirstName: userData.firstName, empLastName: userData.lastName });
				console.log(newEmployee.empNo);
			} catch (error) {
				console.error(error)
			}
		}
	...
	// 		const data = await updateUserProfileCompletion(newEmployee.empNo);
		...
		try {
			...
			if (success !== undefined) {
				...
				try {
					...
					toast.error("Employee added, but failed to update user profile completion status");
				}
			...
			<section className="container mt-5 mb-5">
				<div className="row justify-content-center">
					<div className="col-md-8 col-lg-6">
						<Toaster />
						<h2 className="mt-5 mb-2">Self Registration</h2>
						{/* {successMessage && (
